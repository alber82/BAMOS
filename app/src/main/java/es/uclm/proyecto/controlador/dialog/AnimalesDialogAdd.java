...
public class AnimalesDialogAdd extends DialogFragment implements View.OnClickListener,View.OnTouchListener, View.OnKeyListener{
    ...
    private AutoCompleteTextView ACTVInvestigadores;
...
//        actionBar.setDefaultDisplayHomeAsUpEnabled(false);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.dialog_add_animal, container, false);

        LinearLayout Parent = (LinearLayout) view.findViewById(R.id.add_animal_layout);
        ...
        if (actionBar != null) {
            final AnimalesDialogAdd window = this;
            actionBar.setTitle(R.string.animal_add);
                          ...
                          default:
                              if(guardado==0) {
                                  new AlertDialog.Builder(getActivity())
                                          ...
                                          .setMessage(R.string.dialog_exit_animals)
                ...
                public boolean onMenuItemClick(MenuItem item) {
                    ...
                    switch (id) {
                        case R.id.action_done:
                            ...
                            guardado = nuevoAnimal();
                            if (guardado == 1) {
                                AnimalesFragment AnimalesFragment = new AnimalesFragment();
                                FragmentTransaction fragmentTransaction = getActivity().getSupportFragmentManager().beginTransaction();
                                fragmentTransaction.replace(R.id.frame, AnimalesFragment, "FragmentAnimal");
    ...
    public int nuevoAnimal(){
        ...
        if (strCodigo.equals("") ||
            ...
            ContentValues cvAnimal = new ContentValues();
            ...
            insercion = getActivity().getContentResolver().insert(ContratoBBDD.Animales.URI_CONTENIDO, cvAnimal);
            _id= ContratoBBDD.Animales.obtenerCodigoAnimal(insercion);

            Log.d("A", _id);
            new AlertDialog.Builder(getDialog().getContext())
                    .setTitle(R.string.dialog_warning)
                    .setMessage(R.string.dialog_animal_record)
                    .setCancelable(false)
                    .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
 ...
 /*   public void onCancel(final DialogInterface dialog) {
        ...
        if(guardado==0) {
            new AlertDialog.Builder(getActivity())
                    ...
                    .setMessage("Se perderan los datos del animal")
